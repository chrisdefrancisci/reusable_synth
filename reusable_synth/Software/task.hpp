...
/**
 * @brief This contains abstract interface for tasks and task management interfaces.
 *
 *
 */
...
public:
  ...
  timer() : start_tick(0), interval_ticks(0) {}

  void start_interval(tick_type interval);
  bool timeout() const;

  static constexpr tick_type milliseconds(tick_type ms) { return ms; } // assuming 1 tick = 1 ms
...
public:
  ...
  task_control_block(const function_type f, const tick_type c, const tick_type o = 0U) : function(f), cycle(c), time()
  {
